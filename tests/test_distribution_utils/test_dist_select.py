...
class TestClass(BaseTestClass):
    ...
    def test_univar_dist_select(self):
        ...
        # Call the function
        dist_df = (
            univariate_dist_class().dist_select(target, candidate_distributions, max_iter=2).reset_index(drop=True)
        )
    ...
    def test_flow_select(self):
        ...
        # Call the function
        dist_df = flow_dist_class().flow_select(target, candidate_flows, max_iter=2).reset_index(drop=True)
    ...
    def test_mixture_dist_select(self):
        ...
        # Call the function
        dist_df = mixture_dist_class().dist_select(target, candidate_distributions, max_iter=2).reset_index(drop=True)
    ...
    def test_multivar_dist_select(self):
        ...
        # Call the function
        dist_df = (
            multivariate_dist_class().dist_select(target, candidate_distributions, max_iter=2).reset_index(drop=True)
        )
