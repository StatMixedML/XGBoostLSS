...
## `News`
:boom: [2023-08-25] Release of v0.5.0 - python 3.13 support and dependency minimization. See the [release notes](https://github.com/StatMixedML/XGBoostLSS/releases) for an overview. <br/>
