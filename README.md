...
We evaluate distributional forecasts using Continuous Ranked Probability Scoring Rules (CRPS) implemented in the [scoringRules](https://cran.r-project.org/web/packages/scoringRules/index.html) R-package, where lower scores indicates a better forecast, along with additional error measures evaluating the mean-prediction accuracy of the models.

```r
            CRPS_SCORE   MAPE    MSE   RMSE    MAE MEDIAN_AE  RMSPE  RMSLE   RRSE
XGBoostLSS      1.1393 0.2461 4.1363 2.0338 1.6088    1.3178 0.3895 0.2479 0.7826
gamboostLSS     1.1541 0.2485 4.1596 2.0395 1.6276    1.3636 0.3900 0.2492 0.7848
GAMLSS          1.1527 0.2478 4.1636 2.0405 1.6251    1.3537 0.3889 0.2490 0.7852
```
