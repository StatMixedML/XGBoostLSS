...
from xgboost_lss.distributions import *
...
class xgboostlss:
    ...
    def train(params, dtrain, dist, num_boost_round=10, evals=(),
        ...
        """Train a xgboost_lss model with given parameters.
        ...
        dtrain : DMatrix
            Data to be trained.
        dist: xgboost_lss.distributions class
    ...
    def cv(params, dtrain, dist, num_boost_round=10, nfold=3, stratified=False, folds=None,
        ...
        """Function to cross-validate a xgboost_lss model with given parameters.
    ...
    def predict(booster: xgb.Booster, dtest: xgb.DMatrix, dist: DistributionType, pred_type: str,
        ...
        '''A customized xgboost_lss prediction function.
    ...
    def plot(booster: xgb.Booster, X: pd.DataFrame, feature: str = "x", parameter: str = "location",
        ...
        '''A customized xgboost_lss plotting function.
